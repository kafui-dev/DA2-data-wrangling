This is from the course on edX, by IBM on data analysis with Python.
It covers various topics including data manipulation, visualization, and statistical analysis using Python libraries such as Pandas, NumPy, Matplotlib, and Seaborn.

It's the 2nd module in the course.
